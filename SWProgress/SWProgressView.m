...
- (UILabel *)progressLabel{
    if (_progressLabel == nil){
        ...
        NSString *valueStr = [[NSString stringWithFormat:@"已售%.0f",value]stringByAppendingString:@"%"];
        lb.text = valueStr;
...
- (void)layoutSubviews{
    ...
    self.Lheight = self.frame.size.height;
...
- (void)setProgressCornerRadius:(NSInteger)progressCornerRadius{
    ...
    _progressCornerRadius = self.frame.size.height * 0.5;
}
